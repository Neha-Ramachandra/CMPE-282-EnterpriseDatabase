...
import com.enterprisedatabase.dao.PaymentDAO;
...
public class PaymentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			boolean isValid = paymentDAO.isIdValidCustomer(Integer.parseInt(customerId));
			if (isValid)
...

			{
				...
				htmlRespone1 += "<h2><b>There are no customers under the</b> </br> customerId: " + customerId + " who has done any payment</h2>"; 
				htmlRespone1 += "</html>"; 
